...
def main(argv=None):
    ...
    try:
        ...
        # Normalize protein rows 
        # For every protein base seen as pr_<B>, NOT_pr_<B>, or NOT_<B> (ignoring *_AC and *_IN),
        # ensure BOTH rows pr_<B> and NOT_pr_<B> exist zeros if never referenced.
        def protein_base(v: str):
            if v.endswith("_AC") or v.endswith("_IN"):
                return None
